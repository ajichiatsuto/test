...
namespace Unity.Services.Samples.ServerlessMultiplayerGame
{
    ...
    public class RemoteConfigManager : MonoBehaviour
    {
        ...
        void Awake()
        {
            Debug.Log("RemoteConfigManager.Awake()");
        ...
        {
            Debug.Log("RemoteConfigManager.FetchConfigs()");
            try
            {
        ...
        {
            Debug.Log($"RemoteConfigManager.GetConfigForPlayers({numPlayers})");
        ...
        {
            Debug.Log("RemoteConfigManager.GetConfigValues()");
        ...
        void OnDestroy()
        {
            Debug.Log("RemoteConfigManager.OnDestroy()");
            if (instance == this)
            {
                instance = null;
            }
