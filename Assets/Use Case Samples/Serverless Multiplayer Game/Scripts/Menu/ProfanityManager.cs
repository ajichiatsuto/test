...
namespace Unity.Services.Samples.ServerlessMultiplayerGame
{
    ...
    public static class ProfanityManager
    {
        ...
        {
            Debug.Log("ProfanityManager.Initialize()");
        ...
        {
            Debug.Log($"IsValidPlayerName({playerName})");
            Debug.Log($"return : {s_ValidPlayerNames.Contains(playerName)}");
        ...
        {
            Debug.Log($"SanitizePlayerName({playerName})");
        ...
        {
            Debug.Log($"IsValidLobbyName({lobbyName})");
            ...
            Debug.Log($"lobbyNameWords: {lobbyNameWords}");
        ...
        {
            Debug.Log($"AddUniqueLobbyWords({lobbyName})");
