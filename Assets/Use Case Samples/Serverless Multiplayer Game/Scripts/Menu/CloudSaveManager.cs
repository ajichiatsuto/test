...
namespace Unity.Services.Samples.ServerlessMultiplayerGame
{
    ...
    public class CloudSaveManager : MonoBehaviour
    {
        ...
        void Awake()
        {
            Debug.Log("CloudSaveManager.Awake()");
        ...
        {
            Debug.Log("CloudSaveManager.LoadAndCacheData()");
            try
            {
        ...
        {
            Debug.Log($"CloudSaveManager.SetPlayerName({playerName})");
            try
            {
        ...
        {
            Debug.Log($"CloudSaveManager.UpdatePlayerStats({results})");
        ...
        {
            Debug.Log($"CloudSaveManager.UpdateWinCount({playerId}, {results})");
        ...
        {
            Debug.Log($"CloudSaveManager.GetPlayerScore({playerId}, {results})");
        ...
        {
            Debug.Log($"CloudSaveManager.UpdateHighScores({currentGameScore})");
        ...
        {
            Debug.Log($"CloudSaveManager.SavePlayerStats()");
            try
            {
                var data = new Dictionary<string, object>();
                data[k_PlayerStatsKey] = JsonUtility.ToJson(m_PlayerStats);
        ...
        {
            Debug.Log($"CloudSaveManager.SaveUpdatedData({data})");
            try
            {
        ...
        void OnDestroy()
        {
            Debug.Log("CloudSaveManager.OnDestroy()");
            if (instance == this)
            {
                instance = null;
            }
